...
import ContentAIControlPanel from '@/components/admin/ContentAIControlPanel'
...
export default async function AdminContentPage() {
  ...
  if (!session?.user || !isFounder(session.user)) {
    redirect('/signin?callbackUrl=' + encodeURIComponent('/admin/content'))
  }

  return <ContentAIControlPanel />
}
